...
<form action="{{url('recordscore')}}" method="POST">
...
<body dir="ltr">
    ...
    <div id="dark-background">
        ...
        <div id="dlgbox">
            ...
            <div id="dlg-footer">
                <input id="score" type="text" name="score" hidden>
                <button type="button" onclick="dlgCancel()">CANCEL</button>
                <button type="submit" onclick="dlgConfirm()">CONFIRM</button>
            </div>
        </div>
    </div>
</form>
    ...
    <div id="claroPage">
        ...
        <div id="topBanner">
            ...
            <div id="platformBanner">
                <div id="campusBannerLeft">
                    <span id="siteName">
                        <a href="http://claroline.hcdc.edu.ph/claroline/index.php" target="_top">
        ...
        <div>
            <div style="display: flex; margin: 0px 10px;">
                ...
                <div
                    style="border: solid lightgray; border-width: 0px 1px 1px 1px; padding: 10px; flex-grow: 1; justify-self: stretch  ;">
                    <h2 style="font-size: 28px; margin: 0px; padding: 0px;">EXERCISE: QUIZ 1</h2>
                    <p style="margin: 0px; padding: 0px;">Current time: 25 mins 45 sec..</p>
                    <p style="margin: 0px; padding: 0px;">Maximum allowed time: 40 mins</p>
                    <p style="margin: 0px; padding: 0px;">Atemp 1 on 1</p>
                    <div style="display: flex; justify-items: center; align-items: center;">
                        <div style=" height: 40px; width: 80px; flex-shrink: 0;"><button id="prevQuestion"
                                style="height: 100%; width: 100%; margin: 0px;">Prev</button></div>
                        <div style="border: 1px solid lightgray; margin: 10px auto; padding: 10px; flex-grow: 1;">
                            <p id=question>Here</p>
                            <input id="answer" type="text" style="padding: 5px; width: 80%;" />
                        </div>
                        <div style=" height: 40px; width: 80px; flex-shrink: 0;"><button id="nextQuestion"
                                style="height: 100%; width: 100%; margin: 0px;">Next</button></div>
                    </div>
                    <div style="display: flex; justify-content: center;"><button id="submitTheTest"
                            style="background-color: cornflowerblue; padding: 5px; margin: 10px;">SUBMIT THE
                            TEST</button></div>
                </div>
            </div>
        </div>
